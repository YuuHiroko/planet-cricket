...
async function pushCloud() {
  const t = document.getElementById('gh-token') ? document.getElementById('gh-token').value.trim() : AppState.get().githubToken;
  if (!t) return showToast('Please enter your GitHub Token first', 'err');
